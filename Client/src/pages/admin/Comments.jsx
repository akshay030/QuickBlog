...
const Comments = () => {
  ...
  return (
    <div className="flex-1 pt-5 px-5 sm:pt-12 sm:pl15 bg-blue-50/50">
      ...
      <div className="relative h-4/5 max-w-auto overflow-x-auto mt-4 bg-white shadow rounded-lg scrollbar-hide">
