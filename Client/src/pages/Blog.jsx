  ...
  return data? (
    <div className="relative">
      ...
      <div className="text-center mt-20 text-gray-600">
        <p className="text-primary py-4 font-medium">Pusblished on {Moment(data.createdAt).format('MMMM Do YYYY')}</p>
      ...
      <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6">
        ...
        <div className=" my-24 max-w-3xl mx-auto">
          ...
          <div className="flex">
            <img src={assets.facebook_icon} alt='' width={50} className="" />
            <img src={assets.twitter_icon} alt='' width={50} className="" />
            <img src={assets.googleplus_icon} alt='' width={50} className="" />
